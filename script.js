  ...
  window.addEventListener('load', function() {
    ...
    loadAllImages(function(loadedAssets, errorMessage) {
      if(typeof errorMessage !== "string") {
        ...
        p.push(new DogeText(cx, cy, "Sabia que dirias que si"));
        p.push(new DogeText(cx, cy, "Que afortunada eres", 45, 50, -100, new RGB(255, 0, 255)));
        p.push(new DogeText(cx, cy, "Give me a kiss?", -55, -220, -110, new RGB(255, 255, 0)));
        p.push(new DogeText(cx, cy, "Ya no hay vuelta atras XD", 55, 160, -160, new RGB(0, 255, 0)));
        p.push(new DogeText(cx, cy, "7u7", -12, 260, -20, new RGB(0, 100, 255)));
        p.push(new DogeText(cx, cy, "UwU", 50, -180, 110, new RGB(255, 100, 0)));
